  ...
  return (
    <div>
      ...
      <div>
        ...
        />
        <button onClick={agregarMeta}className="Agregar">Agregar Meta</button>
      </div>
      <ul>
        {metas.map((meta, index) => (
          <li>
            <span className='nota' style={{ textDecoration: meta.completada ? 'line-through' : 'none' }}>
              {meta.texto}
            </span>
            <button onClick={() => eliminarMeta(index)}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
            ...
            <button onClick={() => Completada(index)}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
